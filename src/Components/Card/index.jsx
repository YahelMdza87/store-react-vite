    ...
    return (
        <div className="bg-white cursor-pointer w-56 h-60  rounded-lg">
            <figure className="relative mb-2 w-full h-4/5">
                ...
                <img className="w-full h-full object-cover rounded-lg" src="https://www.clikisalud.net/wp-content/uploads/2018/07/el-importante-beneficio-de-usar-ropa-holgada.jpg" alt="headphones" />
